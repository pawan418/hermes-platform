...
<body>
    ...
    <section class="services-section" style="padding-top: 8rem; padding-bottom: 2rem;">
        <div class="section-header">
            ...
            <p>Explore our complete catalog of smart conversational systems, multi-tenant SaaS structures, and custom deep learning agents.</p>
        </div>
            ...
            <?php foreach ($services as $service): ?>
                <div class="glass-card service-card" data-tilt data-tilt-max="12" data-tilt-speed="450" data-tilt-glare data-tilt-max-glare="0.15" data-category="<?php echo htmlspecialchars($service['category']); ?>">
                    ...
                    <div class="service-card-footer">
                        ...
                        <a href="<?php echo htmlspecialchars(resolve_url('service/' . $service['slug'], $base_path)); ?>" class="service-card-btn">View Blueprint <i data-lucide="chevron-right" style="width: 14px; height: 14px;"></i></a>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
