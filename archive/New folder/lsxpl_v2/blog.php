<?php
// lsxpl/blog.php - Dynamic AI Blog Index Page
...
$initial_logo = $base_path . 'logo-dark.png';
...
<head>
    ...
    <title>AI & SaaS Insights | <?php echo htmlspecialchars($site['site_title'] ?? 'LSXPL'); ?></title>
    <meta name="description" content="Explore cutting-edge publications, vector database RAG studies, and outbound calling voice agent blueprints from the LSXPL AI Lab.">
...
<body>
    ...
    <main class="blogs-section" style="margin-top: 10rem;">
        <div class="section-header">
            <span class="badge badge-accent">LSXPL Insights</span>
            <h2>AI Lab Publications & Research Logs</h2>
            <p>Read our scientific publications and technical logs detailing neural workflows, vector lookups, and API safety middleware.</p>
        </div>
            ...
            <div class="blogs-grid">
                <?php foreach ($blogs as $post): ?>
                    <div class="glass-card blog-card" data-tilt data-tilt-max="10" data-tilt-speed="400" data-tilt-glare data-tilt-max-glare="0.12">
                        ...
                        <a href="<?php echo htmlspecialchars(resolve_url('blog/' . $post['slug'], $base_path)); ?>" class="blog-card-btn">Read Publication <i data-lucide="arrow-right" style="width: 14px; height: 14px;"></i></a>
                    </div>
                <?php endforeach; ?>
            </div>
        <?php endif; ?>
