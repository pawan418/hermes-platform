...
$user_role = $_SESSION['lspl_xyz_admin_role'] ?? '';
$user_username = $_SESSION['lspl_xyz_admin_username'] ?? '';
$user_id = $_SESSION['lspl_xyz_admin_user_id'] ?? 0;

$role_tabs = [
    'administrator' => ['leads', 'services', 'pages', 'blogs', 'menus', 'reviews', 'users', 'settings', 'account'],
    'site_manager' => ['settings', 'pages', 'blogs', 'leads', 'reviews', 'account'],
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        if ($action === 'update_lead_status') {
            ...
            if (!in_array($user_role, ['administrator', 'service_manager'])) { throw new Exception('Unauthorized action.'); } // Add Course
            ...
            if (!in_array($user_role, ['administrator', 'service_manager'])) { throw new Exception('Unauthorized action.'); } // Edit Course
            ...
            if ($id === (int)$_SESSION['lspl_xyz_admin_user_id']) {
    ...
    <div class="admin-sidebar glass-panel">
        ...
        <ul class="admin-nav">
            ...
            <li class="admin-nav-item <?php echo $current_tab === 'leads' ? 'active' : ''; ?>">
                <a href="?tab=leads"><i data-lucide="inbox"></i> Inquiries CRM</a>
            </li>
            <?php endif; ?>
            <?php if (in_array('services', $allowed_tabs)): ?>
            <li class="admin-nav-item <?php echo $current_tab === 'services' ? 'active' : ''; ?>">
                <a href="?tab=services"><i data-lucide="graduation-cap"></i> Courses CRUD</a>
            </li>
            <?php endif; ?>
            ...
            <div>
                ...
                <h1 style="font-size: 2rem; margin-top: 0.25rem;">
                    ...
                    $tab_names = [
                        ...
                        'users' => 'Academy User Accounts & Roles',
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div style="display: flex; gap: 0.5rem;">
                                            ...
                                            <?php if ($usr['id'] !== (int)$_SESSION['lspl_xyz_admin_user_id']): ?>
