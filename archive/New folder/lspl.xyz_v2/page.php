<?php
// lspl.xyz/page.php - Dynamic CMS Page Layout for LSPL Academy
...
<head>
    ...
    <title><?php echo htmlspecialchars($page['title']); ?> | <?php echo htmlspecialchars($site['site_title'] ?? 'LSPL Academy'); ?></title>
    <meta name="description" content="<?php echo htmlspecialchars(substr(strip_tags($page['content']), 0, 160) ?: ($page['title'] . ' subpage of ' . ($site['site_title'] ?? 'LSPL Academy'))); ?>">
