<?php
// longwaysoftronix/blog.php - Dynamic Blog Index Page
...
<head>
    ...
    <title>Insights Blog | <?php echo htmlspecialchars($site['site_title'] ?? 'LSPL'); ?></title>
    <meta name="description" content="Explore articles on Laravel MVC scaling, e-commerce architectures, native iOS and Android application design, and custom cloud server setups from LSPL.">
...
<body>
    ...
    <main class="blogs-section" style="margin-top: 10rem;">
        <div class="section-header">
            ...
            <h2>Our Latest Engineering Blog</h2>
            <p>Read our articles on database structures, scalable coding frameworks, API audits, and e-commerce setups.</p>
        </div>
