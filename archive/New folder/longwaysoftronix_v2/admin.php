...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        if ($action === 'update_lead_status') {
            ...
            if ($id === (int)$_SESSION['lspl_admin_user_id']) {
        ...
        <?php elseif ($current_tab === 'settings'): ?>
            <div class="glass-card admin-card">
                ...
                <form method="POST" action="admin.php?tab=settings" enctype="multipart/form-data" class="edit-form-grid">
                    ...
                    <h4 class="full-width" style="margin-top: 1.5rem; border-bottom: 1px dashed hsl(var(--border)); padding-bottom: 0.5rem; color: hsl(var(--primary));">5. Branding & Logo</h4>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div style="display: flex; gap: 0.5rem;">
                                            ...
                                            <?php if ($usr['id'] !== (int)$_SESSION['lspl_admin_user_id']): ?>
