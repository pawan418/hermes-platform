<?php
// longwaysoftronix/login.php - Secure admin login form for LSPL Main Site
    ...
    if (empty($username) || empty($password)) {
        ...
        try {
            ...
            if ($user && password_verify($password, $user['password'])) {
                $_SESSION['lspl_admin_logged_in'] = true;
                $_SESSION['lspl_admin_username'] = $user['username'];
                $_SESSION['lspl_admin_role'] = $user['role'];
                $_SESSION['lspl_admin_user_id'] = $user['id'];
...
<head>
    ...
    <title>LSPL Admin Dashboard | Secure Login</title>
...
<body class="login-body">
    ...
    <div class="glass-panel login-card">
        <div class="login-header">
            <img src="logo.png" alt="LSPL Logo" style="max-height: 48px; width: auto; object-fit: contain;">
            <h2>LSPL Admin Area</h2>
            <p>Enter your credentials to manage pages and leads</p>
        </div>
