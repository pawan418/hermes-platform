    ...
    <main class="page-container" style="margin-top: 9rem;">
        <div class="glass-card">
            ...
            <div style="margin-top: 4rem; text-align: center; display: flex; gap: 1rem; justify-content: center; flex-wrap: wrap;">
                <a href="index.php#estimator" class="btn btn-primary" style="padding: 0.85rem 2rem;">Open Fee Estimator</a>
                <a href="index.php#contact" class="btn btn-outline" style="padding: 0.85rem 2rem;">Speak to an Advisor</a>
            </div>
        </div>
    </main>
