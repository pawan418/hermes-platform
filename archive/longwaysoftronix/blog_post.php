<?php
// longwaysoftronix/blog_post.php - Dynamic Blog Post Layout
...
<head>
    ...
    <title><?php echo htmlspecialchars($post['title']); ?> | LSPL Blog</title>
    ...
    <main class="page-container">
        ...
        <?php echo $post['content']; ?>
            ...
            <div style="margin-top: 3.5rem; padding-top: 2rem; border-top: 1px solid hsl(var(--border)); display:flex; justify-content: space-between; align-items: center; flex-wrap:wrap; gap: 1rem;">
                <a href="blog.php" class="btn btn-outline btn-sm"><i data-lucide="arrow-left" style="width: 14px; height: 14px;"></i> Back to Blog</a>
                <span style="font-size:0.85rem; color: hsl(var(--muted-foreground));">Share this: <strong>#LSPL</strong></span>
            </div>
        </div>
    </main>
