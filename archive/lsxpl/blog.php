            ...
            <div class="blogs-grid">
                <?php foreach ($blogs as $post): ?>
                    <div class="glass-card blog-card">
                        ...
                        <a href="blog_post.php?slug=<?php echo htmlspecialchars($post['slug']); ?>" class="blog-card-btn">Read Publication <i data-lucide="arrow-right" style="width: 14px; height: 14px;"></i></a>
                    </div>
                <?php endforeach; ?>
            </div>
        <?php endif; ?>
