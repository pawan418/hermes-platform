<?php
// longwaysoftronix/industry.php - Dynamic Service Subpage
...
<head>
    ...
    <title><?php echo htmlspecialchars($industry['title']); ?> | LSPL Service</title>
    ...
    <main class="page-container" style="margin-top: 9rem;">
        <div class="glass-card">
            ...
            <div class="service-meta-row">
                <span class="badge badge-primary">Industry Solution</span>
