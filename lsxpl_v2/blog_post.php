<?php
// lsxpl/blog_post.php - Dynamic AI Blog Post Layout
...
<head>
    ...
    <title><?php echo htmlspecialchars($post['title']); ?> | LSXPL Blog</title>
...
<div style="margin-top: 3.5rem; padding-top: 2rem; border-top: 1px solid hsl(var(--border)); display:flex; justify-content: space-between; align-items: center; flex-wrap:wrap; gap: 1rem;">
                <a href="<?php echo htmlspecialchars($base_path); ?>blog" class="btn btn-outline btn-sm"><i data-lucide="arrow-left" style="width: 14px; height: 14px;"></i> Back to Publications</a>
                <span style="font-size:0.85rem; color: hsl(var(--muted-foreground));">Share: <strong>#LSXPL #AI</strong></span>
            </div>
        </div>
    </main>
