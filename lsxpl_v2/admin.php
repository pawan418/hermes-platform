        ...
        <?php elseif ($current_tab === 'settings'): ?>
            <div class="glass-card admin-card">
                ...
                <form method="POST" action="?tab=settings" enctype="multipart/form-data" class="edit-form-grid">
                    ...
                    <h4 class="full-width" style="margin-top: 1.5rem; border-bottom: 1px dashed hsl(var(--border)); padding-bottom: 0.5rem; color: hsl(var(--primary));">6. Logo Brand Assets</h4>
